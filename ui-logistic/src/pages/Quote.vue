<template>
  <q-page class="quote-page" padding>
    <div v-if="!pageLoading && isCeg()" class="map-container" ref="map"></div>
...
import LoginPage from "@controleonline/ui-login/src/components/user/login";
import SignUpPage from "@controleonline/ui-login/src/components/user/signup";
