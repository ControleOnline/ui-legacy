...
export default {
  ...
  computed: {
    ...
    updEndpoint() {
      return `${this.$entrypoint}/invoice_taxes/upload-nf?myCompany=${this.myCompany.id}`;
    },
    ...
    urlInvoiceTax() {
      ...
      return `${this.$entrypoint}/vendor/pdf.js/web/viewer.html?file=/invoice_taxes/${this.invoiceTax.id}/download-nf`;        
    },
  },
