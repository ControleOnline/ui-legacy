...
<script>
import UploadFileForm from '@controleonline/quasar-common-ui/src/components/Common@controleonline/quasar-default-ui/src/components/Default/DefaultUpload.vue';
