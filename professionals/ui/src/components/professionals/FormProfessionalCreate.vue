    ...
    <div class="row q-col-gutter-sm">
      <div class="col-xs-12 col-sm-6">
        <q-input
          ...
          class="q-mb-sm"
          :label="
            personType == 'PJ' ? 'Razão social' : $t('professionals.form.name')
          "
          :placeholder="
            personType == 'PJ'
              ? 'Digite a Razão social'
              : $t('professionals.form.placeholder.name')
          "
      ...
      <div class="col-xs-12 col-sm-6">
        <q-input
          ...
          :label="
            personType == 'PJ'
              ? 'Nome fantasia'
              : $t('professionals.form.lastname')
          "
          :placeholder="
            personType == 'PJ'
              ? 'Digite o Nome fantasia'
              : $t('professionals.form.placeholder.lastname')
          "
  ...
  methods: {
    ...
    getValues() {
      return {
        ...
        document: this.item.document.replace(/[.,-]/g, ""),
      };
    },
