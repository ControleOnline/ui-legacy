---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-legacy, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-legacy`.
...
- Checkout local: `app-community/modules/controleonline/ui-legacy`
