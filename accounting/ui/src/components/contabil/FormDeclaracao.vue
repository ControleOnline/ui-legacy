    ...
    <div class="row q-col-gutter-xs q-pb-xs">
      ...
      <div class="col-xs-12 col-sm-6">
        <q-select
          ...
          outlined
          stack-label
          :label="translate('Declaração')"
          v-model="item.declaracao"
          :options="declaracoes"
          class="full-width"
        />
      </div>
      ...
      <div class="col-xs-12">
        ...
        >
          <template v-slot:append>
            <q-icon v-if="true" name="attachment" color="primary" />
            <q-btn
              flat
              round
              dense
...
export default {
  ...
  data() {
    return {
      ...
      declaracoes: [
        {
          label: "Sped ECD (Livros Razão e Diário Digital)",
          value: "sped_ecd",
        },
        {
          label: "Sped ECF (Declaração Imposto de Renda PJ)",
          value: "sped_ecf",
        },
        {
          label: "Outros",
  ...
  methods: {
    ...
    removeFile(data) {
      if (
        window.confirm(this.translate("Tem certeza que deseja eliminar este arquivo?"))
      ) {
      }
    },
