        ...
        <div class="row q-col-gutter-sm">
          <div class="col-xs-12 col-sm-6">
            <q-input stack-label lazy-rules outlined
              ...
              :placeholder="item.type == 'J' ? 'Digite a Razão social' : 'Digite o nome'"
          ...
          <div class="col-xs-12 col-sm-6">
            <q-input stack-label lazy-rules outlined
              ...
              :placeholder="item.type == 'J' ? 'Digite o Nome fantasia' : 'Digite o sobrenome'"
...
export default {
  ...
  methods: {
    // store method
    getSummary() {
      return this.api.private(`customers/${this.id}/summary`)
