<template>
  <q-card style="min-height: 90vh">
    <q-dialog v-model="confirm" persistent>
      <q-card>
        ...
        <q-card-actions align="right">
          ...
          <q-btn flat label="Alterar" color="primary" @click="renew(invoice)" v-close-popup />
        </q-card-actions>
      </q-card>
    </q-dialog>
    ...
    <transition-group appear enter-active-class="animated fadeIn" leave-active-class="animated fadeOut">
      <div v-if="invoice !== null" class="row q-pa-sm q-col-gutter-sm" key="status">
        ...
        <div class="col-xs-12 col-sm-5">
          <div class="row">
            <div class="col-xs-12">
              <q-markup-table flat dense square separator="none" class="bg-grey-4">
                <tbody>
                  <tr>
                    ...
                    <td class="text-left">
                      ...
                      <q-btn flat round dense color="positive" icon="autorenew" @click="confirm = true" />
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="text-left">
                      <EditInvoiceDuedate v-if="editDueDate" :dueDate="invoice.dueDate"
                        :invoiceId="invoice['@id'] || ''" @saved="(data) => (invoice = data)" />
                      <div v-else>
                        {{ invoice.dueDate }}
                      </div>
                    </td>
            ...
            <div class="col-xs-12">
              <InvoiceEditActions :invoice="invoice" @ready="(invoice) => (invoice = invoice)" />
            </div>
          </div>
        </div>
        ...
        <div class="col-12">
          ...
          <q-tab-panels v-model="currentTab">
            <q-tab-panel name="invoice" class="q-pa-none">
              <InvoiceInvoice ref="invoiceBillet" :invoiceId="invoiceId" :orderId="orderId" @billetStatus="
                (status) => {
    ...
    <div v-if="invoice === null && notFound" class="row items-center justify-center" style="min-height: 90vh">
