            ...
            <div class="row">
              ...
              <div class="col-xs-12">
                <q-input stack-label lazy-rules unmasked-value
                  ...
                  :mask  ="dialogs.provider.item.type == 'J' ? '##.###.###/####-##' : '###.###.###-##'"
                />
              </div>
              <div class="col-xs-12">
                <q-input stack-label lazy-rules
                  ...
                  type   ="text"
                  class  ="q-mb-sm"
                  :label ="dialogs.provider.item.type == 'J' ? $t('Razão social') : $t('Nome')"
              ...
              <div class="col-xs-12">
                <q-input stack-label lazy-rules
                  ...
                  type   ="text"
                  class  ="q-mb-sm"
                  :label ="dialogs.provider.item.type == 'J' ? $t('Nome Fantasia') : $t('Sobrenome')"
