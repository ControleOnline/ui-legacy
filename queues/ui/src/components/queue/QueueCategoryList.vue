  ...
  <div class="col-12">
    ...
    >
      <template v-slot:body="props">
        <q-tr :props="props">
          ...
          <q-td :props="props" key="Category"> {{ props.row.category.label }}</q-td>
    ...
    <q-dialog v-model="editCategory">
      <q-card style="width:50%">
        ...
        <QueueCategoryCreate :catQueue="this.selectedCatQueue" @savedItem="saved"></QueueCategoryCreate>
      </q-card>
    </q-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getItems(params) {
      return this.api
        .private(`queue_categories`, { params })
        ...
        if (data.members) {
          ...
          for (let index in data.members) {
            this.data.push({
              ...
              category: {
                label: data.members[index]["category"]["name"],
                value: data.members[index]["category"]["@id"].replaceAll("/categories/", ""),
              },
              queue: {
